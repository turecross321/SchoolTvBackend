...
namespace Org.OpenAPITools.Client
{
    ...
    public partial class ApiClient : ISynchronousClient, IAsynchronousClient
    {
        ...
        // this shit wasn't already implemented so hastily added it.
        public static async Task<LoginResponse> Authorize(ILogger logger, string identifier, string secret, string idk)
        {
            logger.LogInformation("Logging into Västtrafik server");
            ...
            var body = new StringContent("grant_type=client_credentials", System.Text.Encoding.UTF8, "application/x-www-form-urlencoded");
            var response = await client.PostAsync("https://ext-api.vasttrafik.se/token", body);
            string str = await response.Content.ReadAsStringAsync();
            LoginResponse parsed = JsonConvert.DeserializeObject<LoginResponse>(str);
            if (response.StatusCode != HttpStatusCode.OK)
                throw new Exception("Failed to log in. Invalid credentials? " + response.ReasonPhrase);
