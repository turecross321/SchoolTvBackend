...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VT.ApiPlaneraResa.Web.V4.Models.JourneyDetails.CallApiModel")]
    public partial class VTApiPlaneraResaWebV4ModelsJourneyDetailsCallApiModel : IEquatable<VTApiPlaneraResaWebV4ModelsJourneyDetailsCallApiModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VTApiPlaneraResaWebV4ModelsJourneyDetailsCallApiModel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VTApiPlaneraResaWebV4ModelsJourneyDetailsCallApiModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VTApiPlaneraResaWebV4ModelsJourneyDetailsCallApiModel" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VTApiPlaneraResaWebV4ModelsJourneyDetailsCallApiModel {\n");
        ...
        {
            return this.Equals(input as VTApiPlaneraResaWebV4ModelsJourneyDetailsCallApiModel);
        }

        /// <summary>
        /// Returns true if VTApiPlaneraResaWebV4ModelsJourneyDetailsCallApiModel instances are equal
        /// </summary>
        /// <param name="input">Instance of VTApiPlaneraResaWebV4ModelsJourneyDetailsCallApiModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VTApiPlaneraResaWebV4ModelsJourneyDetailsCallApiModel input)
        {
            if (input == null)
            {
                return false;
