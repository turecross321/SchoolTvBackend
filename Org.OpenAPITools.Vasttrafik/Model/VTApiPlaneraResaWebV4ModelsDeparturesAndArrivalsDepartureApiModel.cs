...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VT.ApiPlaneraResa.Web.V4.Models.DeparturesAndArrivals.DepartureApiModel")]
    public partial class VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsDepartureApiModel : IEquatable<VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsDepartureApiModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsDepartureApiModel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsDepartureApiModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsDepartureApiModel" /> class.
        /// </summary>
        ...
        public VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsDepartureApiModel(string detailsReference = default(string), VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsServiceJourneyApiModel serviceJourney = default(VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsServiceJourneyApiModel), VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsStopPointApiModel stopPoint = default(VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsStopPointApiModel), string plannedTime = default(string), string estimatedTime = default(string), bool isCancelled = default(bool), bool isPartCancelled = default(bool), VTApiPlaneraResaWebV4ModelsOccupancyInformationApiModel occupancy = default(VTApiPlaneraResaWebV4ModelsOccupancyInformationApiModel))
        {
            // to ensure "stopPoint" is required (not null)
            if (stopPoint == null)
            {
                throw new ArgumentNullException("stopPoint is a required property for VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsDepartureApiModel and cannot be null");
            }
            this.StopPoint = stopPoint;
            // to ensure "plannedTime" is required (not null)
            if (plannedTime == null)
            {
                throw new ArgumentNullException("plannedTime is a required property for VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsDepartureApiModel and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsDepartureApiModel {\n");
        ...
        {
            return this.Equals(input as VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsDepartureApiModel);
        }

        /// <summary>
        /// Returns true if VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsDepartureApiModel instances are equal
        /// </summary>
        /// <param name="input">Instance of VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsDepartureApiModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsDepartureApiModel input)
        {
            if (input == null)
            {
                return false;
