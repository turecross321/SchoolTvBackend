...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VT.ApiPlaneraResa.Web.V4.Models.JourneyDetails.DepartureAccessLinkApiModel")]
    public partial class VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel : IEquatable<VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel" /> class.
        /// </summary>
        ...
        public VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel(VTApiPlaneraResaWebV4ModelsTransportMode? transportMode = default(VTApiPlaneraResaWebV4ModelsTransportMode?), VTApiPlaneraResaWebV4ModelsTransportSubMode? transportSubMode = default(VTApiPlaneraResaWebV4ModelsTransportSubMode?), VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel origin = default(VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel), VTApiPlaneraResaWebV4ModelsJourneyDetailsCallApiModel destination = default(VTApiPlaneraResaWebV4ModelsJourneyDetailsCallApiModel), List<VTApiPlaneraResaWebV4ModelsNoteApiModel> notes = default(List<VTApiPlaneraResaWebV4ModelsNoteApiModel>), int? distanceInMeters = default(int?), string plannedDepartureTime = default(string), string plannedArrivalTime = default(string), int? plannedDurationInMinutes = default(int?), string estimatedDepartureTime = default(string), string estimatedArrivalTime = default(string), int? estimatedDurationInMinutes = default(int?), int? estimatedNumberOfSteps = default(int?), List<VTApiPlaneraResaWebV4ModelsCoordinateApiModel> linkCoordinates = default(List<VTApiPlaneraResaWebV4ModelsCoordinateApiModel>), List<VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkSegmentApiModel> segments = default(List<VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkSegmentApiModel>))
        {
        ...
        public VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkEndpointApiModel Origin { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel {\n");
        ...
        {
            return this.Equals(input as VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel);
        }

        /// <summary>
        /// Returns true if VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel instances are equal
        /// </summary>
        /// <param name="input">Instance of VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VTApiPlaneraResaWebV4ModelsJourneyDetailsDepartureAccessLinkApiModel input)
        {
            if (input == null)
            {
                return false;
