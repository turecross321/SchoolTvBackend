...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VT.ApiPlaneraResa.Web.V4.Models.JourneyDetails.ConnectionLinkApiModel")]
    public partial class VTApiPlaneraResaWebV4ModelsJourneyDetailsConnectionLinkApiModel : IEquatable<VTApiPlaneraResaWebV4ModelsJourneyDetailsConnectionLinkApiModel>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VTApiPlaneraResaWebV4ModelsJourneyDetailsConnectionLinkApiModel" /> class.
        /// </summary>
        ...
        public VTApiPlaneraResaWebV4ModelsJourneyDetailsConnectionLinkApiModel(VTApiPlaneraResaWebV4ModelsTransportMode? transportMode = default(VTApiPlaneraResaWebV4ModelsTransportMode?), VTApiPlaneraResaWebV4ModelsTransportSubMode? transportSubMode = default(VTApiPlaneraResaWebV4ModelsTransportSubMode?), VTApiPlaneraResaWebV4ModelsJourneyDetailsCallApiModel origin = default(VTApiPlaneraResaWebV4ModelsJourneyDetailsCallApiModel), VTApiPlaneraResaWebV4ModelsJourneyDetailsCallApiModel destination = default(VTApiPlaneraResaWebV4ModelsJourneyDetailsCallApiModel), List<VTApiPlaneraResaWebV4ModelsNoteApiModel> notes = default(List<VTApiPlaneraResaWebV4ModelsNoteApiModel>), int? distanceInMeters = default(int?), string plannedDepartureTime = default(string), string plannedArrivalTime = default(string), int? plannedDurationInMinutes = default(int?), string estimatedDepartureTime = default(string), string estimatedArrivalTime = default(string), int? estimatedDurationInMinutes = default(int?), int? estimatedNumberOfSteps = default(int?), List<VTApiPlaneraResaWebV4ModelsCoordinateApiModel> linkCoordinates = default(List<VTApiPlaneraResaWebV4ModelsCoordinateApiModel>), List<VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkSegmentApiModel> segments = default(List<VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkSegmentApiModel>), int journeyLegIndex = default(int))
        {
        ...
        public VTApiPlaneraResaWebV4ModelsJourneyDetailsCallApiModel Destination { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VTApiPlaneraResaWebV4ModelsJourneyDetailsConnectionLinkApiModel {\n");
        ...
        {
            return this.Equals(input as VTApiPlaneraResaWebV4ModelsJourneyDetailsConnectionLinkApiModel);
        }

        /// <summary>
        /// Returns true if VTApiPlaneraResaWebV4ModelsJourneyDetailsConnectionLinkApiModel instances are equal
        /// </summary>
        /// <param name="input">Instance of VTApiPlaneraResaWebV4ModelsJourneyDetailsConnectionLinkApiModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VTApiPlaneraResaWebV4ModelsJourneyDetailsConnectionLinkApiModel input)
        {
            if (input == null)
            {
                return false;
