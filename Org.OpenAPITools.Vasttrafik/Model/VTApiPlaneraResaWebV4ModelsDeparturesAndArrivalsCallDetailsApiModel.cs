...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VT.ApiPlaneraResa.Web.V4.Models.DeparturesAndArrivals.CallDetailsApiModel")]
    public partial class VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsCallDetailsApiModel : IEquatable<VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsCallDetailsApiModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsCallDetailsApiModel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsCallDetailsApiModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsCallDetailsApiModel" /> class.
        /// </summary>
        ...
        public VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsCallDetailsApiModel(VTApiPlaneraResaWebV4ModelsJourneyDetailsStopPointApiModel stopPoint = default(VTApiPlaneraResaWebV4ModelsJourneyDetailsStopPointApiModel), string plannedArrivalTime = default(string), string plannedDepartureTime = default(string), string estimatedArrivalTime = default(string), string estimatedDepartureTime = default(string), string plannedPlatform = default(string), string estimatedPlatform = default(string), double? latitude = default(double?), double? longitude = default(double?), string index = default(string), VTApiPlaneraResaWebV4ModelsOccupancyInformationApiModel occupancy = default(VTApiPlaneraResaWebV4ModelsOccupancyInformationApiModel), bool isCancelled = default(bool), bool? isDepartureCancelled = default(bool?), bool? isArrivalCancelled = default(bool?))
        {
            // to ensure "stopPoint" is required (not null)
            if (stopPoint == null)
            {
                throw new ArgumentNullException("stopPoint is a required property for VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsCallDetailsApiModel and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsCallDetailsApiModel {\n");
        ...
        {
            return this.Equals(input as VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsCallDetailsApiModel);
        }

        /// <summary>
        /// Returns true if VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsCallDetailsApiModel instances are equal
        /// </summary>
        /// <param name="input">Instance of VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsCallDetailsApiModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VTApiPlaneraResaWebV4ModelsDeparturesAndArrivalsCallDetailsApiModel input)
        {
            if (input == null)
            {
                return false;
