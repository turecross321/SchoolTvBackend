...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VT.ApiPlaneraResa.Web.V4.Models.JourneyDetails.LinkSegmentApiModel")]
    public partial class VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkSegmentApiModel : IEquatable<VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkSegmentApiModel>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkSegmentApiModel" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkSegmentApiModel {\n");
        ...
        {
            return this.Equals(input as VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkSegmentApiModel);
        }

        /// <summary>
        /// Returns true if VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkSegmentApiModel instances are equal
        /// </summary>
        /// <param name="input">Instance of VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkSegmentApiModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VTApiPlaneraResaWebV4ModelsJourneyDetailsLinkSegmentApiModel input)
        {
            if (input == null)
            {
                return false;
