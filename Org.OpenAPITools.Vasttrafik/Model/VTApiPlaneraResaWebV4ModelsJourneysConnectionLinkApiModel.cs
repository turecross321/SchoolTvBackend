...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VT.ApiPlaneraResa.Web.V4.Models.Journeys.ConnectionLinkApiModel")]
    public partial class VTApiPlaneraResaWebV4ModelsJourneysConnectionLinkApiModel : IEquatable<VTApiPlaneraResaWebV4ModelsJourneysConnectionLinkApiModel>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VTApiPlaneraResaWebV4ModelsJourneysConnectionLinkApiModel" /> class.
        /// </summary>
        ...
        public VTApiPlaneraResaWebV4ModelsJourneysConnectionLinkApiModel(VTApiPlaneraResaWebV4ModelsTransportMode? transportMode = default(VTApiPlaneraResaWebV4ModelsTransportMode?), VTApiPlaneraResaWebV4ModelsTransportSubMode? transportSubMode = default(VTApiPlaneraResaWebV4ModelsTransportSubMode?), VTApiPlaneraResaWebV4ModelsJourneysCallApiModel origin = default(VTApiPlaneraResaWebV4ModelsJourneysCallApiModel), VTApiPlaneraResaWebV4ModelsJourneysCallApiModel destination = default(VTApiPlaneraResaWebV4ModelsJourneysCallApiModel), List<VTApiPlaneraResaWebV4ModelsNoteApiModel> notes = default(List<VTApiPlaneraResaWebV4ModelsNoteApiModel>), int? distanceInMeters = default(int?), string plannedDepartureTime = default(string), string plannedArrivalTime = default(string), int? plannedDurationInMinutes = default(int?), string estimatedDepartureTime = default(string), string estimatedArrivalTime = default(string), int? estimatedDurationInMinutes = default(int?), int? estimatedNumberOfSteps = default(int?), List<VTApiPlaneraResaWebV4ModelsCoordinateApiModel> linkCoordinates = default(List<VTApiPlaneraResaWebV4ModelsCoordinateApiModel>), List<VTApiPlaneraResaWebV4ModelsJourneysLinkSegmentApiModel> segments = default(List<VTApiPlaneraResaWebV4ModelsJourneysLinkSegmentApiModel>), int journeyLegIndex = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VTApiPlaneraResaWebV4ModelsJourneysConnectionLinkApiModel {\n");
        ...
        {
            return this.Equals(input as VTApiPlaneraResaWebV4ModelsJourneysConnectionLinkApiModel);
        }

        /// <summary>
        /// Returns true if VTApiPlaneraResaWebV4ModelsJourneysConnectionLinkApiModel instances are equal
        /// </summary>
        /// <param name="input">Instance of VTApiPlaneraResaWebV4ModelsJourneysConnectionLinkApiModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VTApiPlaneraResaWebV4ModelsJourneysConnectionLinkApiModel input)
        {
            if (input == null)
            {
                return false;
