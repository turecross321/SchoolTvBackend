...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VT.ApiPlaneraResa.Web.V4.Models.JourneyDetails.LineDetailsApiModel")]
    public partial class VTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel : IEquatable<VTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel" /> class.
        /// </summary>
        ...
        public VTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel(string name = default(string), string backgroundColor = default(string), string foregroundColor = default(string), string borderColor = default(string), VTApiPlaneraResaWebV4ModelsTransportMode? transportMode = default(VTApiPlaneraResaWebV4ModelsTransportMode?), VTApiPlaneraResaWebV4ModelsTransportSubMode? transportSubMode = default(VTApiPlaneraResaWebV4ModelsTransportSubMode?))
        {
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel {\n");
        ...
        {
            return this.Equals(input as VTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel);
        }

        /// <summary>
        /// Returns true if VTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel instances are equal
        /// </summary>
        /// <param name="input">Instance of VTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VTApiPlaneraResaWebV4ModelsJourneyDetailsLineDetailsApiModel input)
        {
            if (input == null)
            {
                return false;
